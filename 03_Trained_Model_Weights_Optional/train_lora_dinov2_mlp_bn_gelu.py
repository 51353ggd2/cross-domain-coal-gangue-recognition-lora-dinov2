...
def main():
    ...
    data_root = r"F:\00_Coal_Gangue_Recognition_Paper\3.30_DINOv2\dataset\实验室dataset_4_14暗化处理"
    save_dir = r"F:\00_Coal_Gangue_Recognition_Paper\3.30_DINOv2\LoRA_DINOv2\权重file\lab_enhance\runs_mlp_bn_gelu"
